...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/RJ-TUNNEL/permission/main/ip > /root/tmp
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo -e "$COLOR1┌────────────────────── BY ───────────────────────┐${NC}"
echo -e "$COLOR1│${NC}                • RJ-TUNNEL •                 $COLOR1│$NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}" 
echo ""
...
03 | 3) clear ; delvmess ;;
04 | 4) clear ; cekvmess ;;
05 | 5) clear ; wget https://raw.githubusercontent.com/RJ-TUNNEL/xraylite/main/trialvmess.sh && chmod +x trialvmess.sh && ./trialvmess.sh ;;
00 | 0) clear ; menu ;;
*) clear ; menu-vmess ;;
esac
